...
export default class Editor extends Component {
    ...
    open(page, cb) {
        ...
        axios
            ...
            .then(() => this.iframe.load('../heiufherf_fji23.html'))
    ...
    restoreBackup(e, backup) {
        ...
        UIkit.modal.confirm('Вы действительно хотите восстановить из резервной копии? все несохраненные данные будут потеряны!', {labels: {ok: 'Восстановить', cancel: 'Отмена'}})
        .then(() => {
            this.isLoading();
            return axios
